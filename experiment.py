...
from utils import make_tuple, AverageMeter, get_logger, save_checkpoint, load_checkpoint, log_csv, save_array_as_tif
...
class Experiment(object):
    def __init__(self, option):
        ...
        # If you have a pretrained model for the loss function, load it here.
        # e.g., load_pretrained(self.pretrained, 'path/to/your/pretrained_loss_model.pth')
    ...
    def train_on_epoch(self, n_epoch, data_loader):
        ...
        for idx, data in enumerate(data_loader):
            ...
            # Inputs: [coarse_ref, fine_ref, coarse_pred], Target: fine_pred
    ...
    def train(self, train_dir, val_dir, patch_size, patch_stride, batch_size,
        ...
        for epoch in range(start_epoch, epochs + start_epoch):
            ...
            if (epoch + 1) % save_interval == 0:
                ...
                self.logger.info(f'Checkpoint saved for epoch {epoch+1} at {checkpoint_path}')
    ...
    def test(self, test_dir, num_workers=0):
        ...
        for inputs in test_loader:
            ...
            # Save the prediction result as a GeoTIFF
            metadata = {
                'driver': 'GTiff',
